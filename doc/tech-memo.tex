\documentclass[11pt]{tsmemo}
\usepackage{wrapfig}

\begin{document}
\toaddress{Pablo Rolandi and Amgen tech team}
\fromaddress{Tom Sgouros, Brown/CCV}
...
\includegraphics[width=1.2\columnwidth]{web/agile_visualizations_sequence.pdf}
...
\includegraphics[width=0.5\columnwidth]{web/mockup.pdf}
\end{wrapfigure}
